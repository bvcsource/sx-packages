...
sudo yum -y localinstall $HOME/packages/rpmbuild/RPMS/*/skylable-sx*-$VERSION-*.rpm

sudo -i sxcp -D $HOME/packages/rpmbuild/RPMS/*/*.rpm sx://indian.skylable.com/vol-packages/experimental-sx/rhel/6/
